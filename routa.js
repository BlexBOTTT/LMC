...
function main() {
    ...
    rectangle("ver5", 300, 200, 140, 140, "gray", "lightgrey");
    rectangle("ver11", 460, 50, 385, 415, "gray", "lightgrey");

    rectangle("program", 500, 42, 172+94, 432, "lightgrey", "gray");
    //rectangle("code", 193, 42, 94, 432, "lightgrey", "");
    // output
    rectangle("output1", 390, 430, 58, 50, "lightgrey", "");
    // rectangle("output2", 341, 27, 30, 117, "lightgrey", "");
    // input
    rectangle("input", 309, 430, 58, 20, "lightgrey", "lightgrey");
    // program count
    rectangle("pc", 310, 206, 20, 20, "lightgrey", "lightgrey");
    // instruction register
    rectangle("ir", 410, 238, 10, 20, "lightgrey", "lightgrey");
    // address
    rectangle("ar", 400, 270, 20, 20, "lightgrey", "lightgrey");
    // accumulator
    rectangle("acc", 340, 337, 38, 20, "lightgrey", "lightgrey");
    rectangle("message", 485, 480, 360, 19, "lightgrey", "lightgrey");
    ...
    button("help", "HELP / LMC INSTRUCTION SET", 635, 505, "window.open('help.html')");
    text("ch", menu, 201, 506, 12, "black");
    text("op", options, 470, 508, 12, "black");
    updatePC(0);
    updateACC(0);
    ...
    text("ver12", "RANDOM ACCESS MEMORY", 500, 20, 24, 24, "black");

    text("ver001", "ASSEMBLY LANGUAGE CODE", 40, 20, 16, "black");
    text("ver01", "CENTRAL PROCESSING UNIT:", 295, 185, 11, 12, "black");
    

    text("ver1", "PROGRAM COUNTER:", 309, 215, 8, 12, "black");
    text("ver2", "INSTRUCTION REGISTER:", 309, 245, 8, 12, "black");
    text("ver3", "ADDRESS REGISTER:", 309, 275, 8, 12, "black");
    text("ver4", "ACCUMULATOR:", 309, 305, 8, 12, "black");

    text("ver7", "INPUT:", 309, 415, 12, 12, "black");
    text("ver8", "OUTPUT:", 390, 415, 12, 12, "black");
...
function main2() {
    for (var i = 0; i < 5; ++i) {
        rectangle("a" + holdI, 473 + (holdI % 10) * 37, 60 + Math.floor(holdI / 10) * 42, 28, 16, "white", "gray");
        setAddress(holdI, 0);
        ++holdI
    }
...
function message(y) {
    text("message", y, 475, 480, 13, "#FF0000")
}
...
function updatePC(x) {
    pCounter = x;
    if (x < 10) x = '0' + x;
    text("pc", x, 400, 206, 16, "black", "onclick", "openPC(this)")
}
...
function reset1() {
    ...
    output2 = "";
    // 390, 430, 58, 50
    text("output1", "", 390, 430, 27, 12, "black");
    text("output2", "", 341, 27, 12, "black");
    outputCount = 0;
    outputCount2 = 0;
    text("ir", "", 410, 238, 20, "black");
    text("ar", "", 400, 270, 20, "black");
    if (savOpenAddress) {
        var x = parseInt(savOpenAddress.id[1]);
        if (savOpenAddress.id.length == 3) x = x * 10 + parseInt(savOpenAddress.id[2]);
        setAddress(x, address[x]);
...
function step1() {
    ...
    if (addr >= 10) {
        text("ar", addr, 400, 270, 20, "black")
    } else {
        text("ar", '0' + addr, 400, 270, 20, "black")
    }
    ...
    switch (inst) {
        ...
        case 9:
            ...
            text("input", inputForm, 309, 430, 12, "black");
...
function outputAcc() {
    if (outputCount % 8 == 7 && outputCount > 8) {
        output1 = output2;
        output2 = "";
        text("output1", output1, 390, 430, 27, 12, "black", "", "", monospace)
    }
    if (outputCount < 7) {
        ...
        output2 += accumulator;
        text("output2", output2, 390, 430, 27, 12, "black", "", "", monospace)
    }++outputCount;
    outputCount2 = 1;
...
function inputSubmit() {
    ...
    text("input", value, 309, 430, 18, "black");
